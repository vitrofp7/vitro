...
public class WsiGeneralAdapterCon extends WsiAdapterCon {

	private Logger logger = LoggerFactory.getLogger(getClass()); 
	
	private WSIAdapter delegate = new WSIAdapterCoap();
	
	private static WsiGeneralAdapterCon myCon = null;
     ...
     */
    public static WsiGeneralAdapterCon getWsiAdapterCon(DbConInfo databaseConnInfo) {
        if (myCon == null) {
            myCon = new WsiGeneralAdapterCon();
                            ...
                            else
                            {
                                ...
                                if(obs != null) {
                                    ...
                                    for (int o = 0; o < mySensorReadings.size(); o++) {
                                        ...
                                        long valueToAdd;
                                        try {
                                            logger.debug("Value to convert to Double:" + mySensorReadings.elementAt(o).getObservOutputMeasurementData()[0]);
