...
public class NotificationsFromVSNs {
    ...
    public static final int ALL_CONDITIONS_MET_TYPE = 4; // will be used at VSP level
    ...
    private String refFunctName; // could be redundant since we also pass the Uid of the reffered function
    ...
    public static String getAlertDelimitedString(NotificationsFromVSNs pSampleNotify) {
        ...
        bldToReturn.append(alertDelimiter);
        bldToReturn.append(pSampleNotify.getTimestamp());
        bldToReturn.append(alertDelimiter);
        bldToReturn.append(pSampleNotify.getMessage());
        bldToReturn.append(alertDelimiter);
    ...
    public String getDetailsInText(boolean isHtml)
    {
        ...
        buildTheString.append(this.getMessage());
