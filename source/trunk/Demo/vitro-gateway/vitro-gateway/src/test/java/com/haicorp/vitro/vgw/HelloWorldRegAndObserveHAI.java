...
/**
 * User: Kyriakos Georgouleas
 */

public class HelloWorldRegAndObserveHAI {
	private Logger logger = Logger.getLogger(getClass());

    private static HelloWorldRegAndObserveHAI mymainapp;

    private HelloWorldRegAndObserveHAI() {

    }

    public static HelloWorldRegAndObserveHAI getHelloWorldRegAndObserve() {
        if(mymainapp == null)
        {
            mymainapp = new HelloWorldRegAndObserveHAI();
        }
        return mymainapp;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        //
        vgs.setAssignedGatewayUniqueIdFromReg("vitrogw_hai2");
...
//      vgs.setDVNSUrl("http://195.235.93.25:9002/idas/sml");    // old IDAS url -- Do not use anymore
        ...
        //
        vgs.setWsiAdapterName("HAIwsiadapter"); //vgs.setWsiAdapterName("uberdust");
        ...
        try{
            ...
            if(vgs.getUseIdas()) {
                HelloWorldRegAndObserveHAI.getHelloWorldRegAndObserve().logger.info("Sending new Observations: temperature");
               ...
               // theCapabilityRequest.setObsType(ObservationType.TEMPERATURE);
                ...
                HelloWorldRegAndObserveHAI.getHelloWorldRegAndObserve().logger.info("Sending new Observations: Barometric");
                ...
                //
                // Also send
                HelloWorldRegAndObserveHAI.getHelloWorldRegAndObserve().logger.info("Sending new Observations: Light");
