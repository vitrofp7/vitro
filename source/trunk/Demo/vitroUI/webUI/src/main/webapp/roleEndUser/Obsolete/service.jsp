...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/googleMapsMarkerSelection.js"></script>
<script type="text/javascript">
...
<div class="row-fluid">
<div class="span1">
    <span style="text-decoration: underline;font-size: x-small;">Filter&nbsp;by<br/>capability:</span><br/>
            <table border="0">
                <tr>
                    <td>
                        <input
...
<div class="span9" id="map_span">
           	<div class="btn-toolbar">
			    <input class="btn" value="Delete last marker" name="deleteLastFlagpostBtn" type="button"
                        onclick="MarkerSelection.DeleteLastPoint(AllMapItems.map);">&nbsp;&nbsp;&nbsp;
                <input class="btn" value="Clear Map Selection" name="clearMapSelectionBtn" type="button"
                       onclick="MarkerSelection.Clean(AllMapItems.map);">&nbsp;&nbsp;&nbsp;
                <input class="btn" value="(un)select all" name="selectionAllOnOffBtn" type="button"
                       onclick="MarkerSelection.SwitchSelectAll(AllMapItems.map);">&nbsp;&nbsp;&nbsp;
                <input class="btn" value="Put Map Selection in Container" name="appendSelectionInMultiSelectionAreaBtn" type="button"
                       onclick="putSelectionInMultiSelectionArea();">&nbsp;&nbsp;&nbsp;
                <input class="btn" value="Fetch Service Data from Map Selection" name="fetchSensorDataFromMapForServiceBtn" type="button"
                       onclick="fetchSensorDataFromMapForService();">&nbsp;&nbsp;&nbsp;
                <input class="btn" value="Remove Map Selection from Service" name="removeSelectionFromMapForServiceBtn" type="button"
