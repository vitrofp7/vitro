...
/**
 * Won't be used to directly show service Instances anymore (we use the one for composed services)
 * #superceded?
 */
public class GetServiceInstanceListAction extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String nextJSP = "/roleVSP/VSPeditVitroServices.jsp";
