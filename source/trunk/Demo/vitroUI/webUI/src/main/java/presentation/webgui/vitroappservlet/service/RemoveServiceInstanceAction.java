...
public class RemoveServiceInstanceAction  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		logger.debug("RemoveServiceInstanceAction - doGet() - Start");
        ...
        logger.debug("Con la remove singola instanceId vale "+instanceId);
