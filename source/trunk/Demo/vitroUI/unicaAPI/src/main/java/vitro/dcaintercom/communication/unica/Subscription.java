...
public class Subscription {
	 ...
	 */
	public static String subscribe(int appId,
                                   String response,
                                   String eventKind,
                                   String notify,
                                   String srvLogicalName,
	 ...
	 * @param response is the URI to which the server must respond with the result of the unsubscription process.
	 * @param logicalName Indicates the reference to the subscription that must be deleted
	 ...
	 * @return the XML file ready to send
	 */
	public static String unsubscribe(int appId,
                                     String response,
                                     String logicalName,
                                     String Outgoing) {
